...
class Piano {
    constructor(tangentHeight) {
        this.tangentHeight = tangentHeight;
        this.notes = [
            { note: "D", isBlack: false, pos: 0 },
            { note: "C#", isBlack: true, pos: 0.5 },
            { note: "C", isBlack: false, pos: 1 },
            { note: "B", isBlack: false, pos: 2 },
            { note: "A#", isBlack: true, pos: 2.5},
            { note: "A", isBlack: false, pos: 3 },
            { note: "G#", isBlack: true, pos: 3.5 },
            { note: "G", isBlack: false, pos: 4 },
            { note: "F#", isBlack: true, pos: 4.5 },
            { note: "F", isBlack: false, pos: 5},
            { note: "E", isBlack: false, pos: 6 },
            { note: "D#", isBlack: true, pos: 6.5},
    ...
    setupTangents() {
        for (let i = 0; i < 100; i++) {
            ...
            let note = this.notes[noteIndex].note;
            ...
            this.tangents.push(new Tangent(yPos, tangentHeight, note, isBlack));
        }
    }
